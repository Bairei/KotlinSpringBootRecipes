...
create table ingredient (id bigint not null, amount decimal(19,2), description varchar(255), recipe_id bigint, uom_id bigint, primary key (id)) engine=InnoDB;
create table notes (id bigint not null auto_increment, recipe_notes longtext, recipe_id bigint, primary key (id)) engine=InnoDB;
create table recipe (id bigint not null auto_increment, cook_time integer not null, description varchar(255), difficulty varchar(255), directions varchar(255), image longblob, prep_time integer not null, servings integer not null, source varchar(255), url varchar(255), notes_id bigint, primary key (id)) engine=InnoDB;
